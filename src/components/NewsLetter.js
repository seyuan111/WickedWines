...
const NewsLetter = () => {
  return (
    <div className="w-full py-6 text-white bg-gradient-to-b from-black to-gray-900 px-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between w-full">
            ...
            <button className="text-white bg-gradient-to-b from-black to-gray-900 border-2 rounded-md font-medium w-[200px] ml-4 my-6 px-6 py-3">Updates</button>
        </div>
