      ...
      <div className="max-w-[1240px] mx-auto px-4 flex justify-between items-center h-full">
        ...
        <div className="hidden md:flex">
          <ul className="flex items-center text-white text-[20px]">
            <li className="ml-4 cursor-pointer">story</li>
            <li className="ml-4 cursor-pointer">shop</li>
            <li className="ml-4 cursor-pointer">news</li>
        ...
        <li className="mb-4 cursor-pointer">news</li>
